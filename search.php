...
if ($search == 'name') {
  $qry = 'SELECT * FROM form WHERE name= ?';
}
elseif($search == 'dob') {
  $qry = 'SELECT * FROM form WHERE dob = ?';
}
elseif($search == 'fathersname') {
  $qry = 'SELECT * FROM form WHERE fathersname = ?';
}
elseif($search == 'adharnumber') {
  $qry = 'SELECT * FROM form WHERE adharnumber = ?';
}
elseif($search == 'phonenumber') {
  $qry = 'SELECT * FROM form WHERE phonenumber = ?';
}
elseif($search == 'residingvillage') {
  $qry = 'SELECT * FROM form WHERE residingvillage = ?';
}
